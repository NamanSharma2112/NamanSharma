          ...
          return (
            ...
            >
              ...
              <span className="flex items-center gap-2">
                ...
                {entry.badge && (
                  <span className="inline-flex items-center justify-center text-[11px] font-medium px-2 py-px rounded-full border border-pink-200 text-pink-500 bg-pink-50 tracking-wide leading-relaxed">
                    {entry.badge}
                  </span>
                )}
              </span>
              <span className="text-sm text-zinc-300 tabular-nums text-right">
                {entry.date}
              </span>
            </div>
          );
