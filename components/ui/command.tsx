...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("-mx-1 h-px w-auto bg-zinc-200 dark:bg-zinc-800", className)}
      {...props}
    />
  )
}
